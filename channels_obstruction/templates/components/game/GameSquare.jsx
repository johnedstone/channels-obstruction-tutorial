...
class GameSquare extends Component {
    ...
    checkAvailable(){
        console.log('made it to checkAvailable')
        console.log('Who is the owner? owner: ' + this.state.owner)
        if (this.props.isPlayerTurn()){
            console.log('Is it this players turn: yes or no')
            // check if a valid place to make a move
            if (this.state.owner == null){
                console.log('Is it this players turn? Yes')
                // no owner
                
                return true
            }else{
                // owned either as a core spot or a surrounding spot
                console.log('Is it this players turn? No')
                return false
            }
        } else {
